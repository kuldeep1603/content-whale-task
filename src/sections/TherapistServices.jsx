    ...
    return (
        <Container className='bg-white py-16'>
            ...
            <div className="grid md:grid-cols-4 grid-cols-2 md:gap-20 md:px-24">
                <div className="">
                    <img src="/public/assets/images/TherapistServices/Internships.png" alt="" className='w-full h-auto p-5 sm:p-10 md:p-0' />
                </div>
                <div className="">
                    <img src="/public/assets/images/TherapistServices/Workshops.png" alt="" className='w-full h-auto p-5 sm:p-10 md:p-0' />
                </div>
                <div className="">
                    <img src="/public/assets/images/TherapistServices/Mentorship.png" alt="" className='w-full h-auto p-5 sm:p-10 md:p-0' />
                </div>
                <div className="">
                    <img src="/public/assets/images/TherapistServices/Therapy.png" alt="" className='w-full h-auto p-5 sm:p-10 md:p-0' />
                </div>
            </div>
        </Container>
    )
